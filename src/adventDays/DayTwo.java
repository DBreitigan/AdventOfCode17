...
public class DayTwo {
    private final String input = "5048\t177\t5280\t5058\t4504\t3805\t5735\t220\t4362\t1809\t1521\t230\t772\t1088\t178\t1794\n" +
    ...
    private int[][] stringTo2DIntArray() {
        ...
        BufferedReader bufRdr = new BufferedReader(new StringReader(input));
        String line;
        int row = 0, col = 0;
        try {
